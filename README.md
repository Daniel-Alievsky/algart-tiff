...
This library includes the utility [Tiff Information Viewer](https://algart.net/java/AlgART-TIFF/tiff-info.html) allowing to inspect and decode the structure of TIFF files.
