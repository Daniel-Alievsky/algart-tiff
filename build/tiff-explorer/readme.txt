...
1. TiffExplorer.cmd (Windows) or TiffExplorer.sh (Unix)
   ----------------------------------------------------
...
2. TiffInfo.cmd (Windows) or TiffInfo.sh (Unix)
   --------------------------------------------
   Command-line version of TiffExplorer.
...
- On Windows, you can run TiffExplorer by double-clicking the "TiffExplorer.cmd" or "TiffExplorer.jar" file.
